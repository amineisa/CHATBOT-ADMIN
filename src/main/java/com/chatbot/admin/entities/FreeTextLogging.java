...
public class FreeTextLogging implements Serializable {
	...
	@Id
	@Column(name = "ID")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="FREE_TEXT_seq_gen")
	@SequenceGenerator(name="FREE_TEXT_seq_gen", sequenceName="FREE_TEXT_SEQ",initialValue=1,allocationSize=1)
